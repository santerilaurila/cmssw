...
from TauAnalysis.MCEmbeddingTools.customisers_singletau import customisoptions,customiseMerging_Reselect 
...
#call to customisation function customiseMerging_Reselect imported from TauAnalysis.MCEmbeddingTools.customisers_singletau
